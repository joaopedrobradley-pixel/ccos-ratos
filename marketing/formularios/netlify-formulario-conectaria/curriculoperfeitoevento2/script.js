...
// "curriculoperfeitoevento2" (ver seção 5 de reference_processo_criacao_formularios).
...
const FORM_SOURCE = "curriculoperfeitoevento2";
...
const SESSION_KEY = "cpe2_session_id";
const ANSWERS_KEY = "cpe2_answers";

function getSessionId(){
  let id = localStorage.getItem(SESSION_KEY);
  if(!id){
    id = "cpe2_" + Date.now().toString(36) + "_" + Math.random().toString(36).slice(2, 10);
