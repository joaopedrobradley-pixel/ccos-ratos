...
const SESSION_KEY = "cp3_session_id";
const ANSWERS_KEY = "cp3_answers";

function getSessionId(){
  let id = localStorage.getItem(SESSION_KEY);
  if(!id){
    id = "cp3_" + Date.now().toString(36) + "_" + Math.random().toString(36).slice(2, 10);
