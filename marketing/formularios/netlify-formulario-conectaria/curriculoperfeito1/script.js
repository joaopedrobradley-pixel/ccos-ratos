...
const FORM_SOURCE = "curriculoperfeito1";
...
const steps = [
  ...
  },
  {
    ...
    note: "O <strong>Currículo Perfeito</strong> acontece no dia <strong>12/08, às 19h</strong>, no horário de Brasília. A aula será ao vivo e não ficará gravada. Fique de olho no grupo do WhatsApp, porque é por lá que enviaremos o link de acesso e todos os avisos importantes."
  }
];
...
const ANSWERS_KEY = "cp_answers";

function getSessionId(){
  let id = localStorage.getItem(SESSION_KEY);
  if(!id){
    id = "cp_" + Date.now().toString(36) + "_" + Math.random().toString(36).slice(2, 10);
