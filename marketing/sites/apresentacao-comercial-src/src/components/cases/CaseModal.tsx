...
export function CaseModal({ open, onOpenChange, data }: Props) {
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent
        className="max-h-[92vh] max-w-3xl overflow-y-auto rounded-3xl border-ink/10 bg-paper p-0 [&>button.absolute]:hidden"
      >
        <VisuallyHidden>
        ...
        <DialogClose
          aria-label="Fechar"
          className="absolute right-5 top-5 z-20 text-white/90 transition hover:text-white focus:outline-none"
        >
