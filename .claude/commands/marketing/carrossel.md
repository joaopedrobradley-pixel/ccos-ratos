...
Ler `.claude/commands/marketing/carrossel-refs/design-carrossel.md`. Se o arquivo contiver a linha `<!-- estilo: pendente -->`, significa que o usuário ainda não escolheu o estilo. Perguntar:
...
Conforme a resposta, **substituir o conteúdo inteiro** de `.claude/commands/marketing/carrossel-refs/design-carrossel.md` pelo conteúdo do arquivo de estilo escolhido:
- Minimalista: copiar conteúdo de `.claude/commands/marketing/carrossel-refs/design-minimalista.md`
- Elaborado: copiar conteúdo de `.claude/commands/marketing/carrossel-refs/design-elaborado.md`
- Tweet: copiar conteúdo de `.claude/commands/marketing/carrossel-refs/design-tweet.md`

Se `.claude/commands/marketing/carrossel-refs/design-carrossel.md` NÃO contiver `<!-- estilo: pendente -->`, o estilo já foi escolhido. Não perguntar de novo.
...
- **Regras de design:** `.claude/commands/marketing/carrossel-refs/design-carrossel.md` (dentro desta skill)
...
2. Ler `.claude/commands/marketing/carrossel-refs/design-carrossel.md` pra regras de design (layouts, ritmo, imagens, elementos fixos)
...
> **Dica:** se o usuário não gostar do visual, as regras de design ficam em `.claude/commands/marketing/carrossel-refs/design-carrossel.md`. Pode editar direto ou pedir: "muda a regra X no design do carrossel".
...
- Regras de design vivem em `.claude/commands/marketing/carrossel-refs/design-carrossel.md`. Se o usuário quiser mudar algo visual, editar lá
