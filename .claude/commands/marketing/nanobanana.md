...
### 4. Chamar a API e salvar a imagem
...
```powershell
$prompt = [Uri]::EscapeDataString("descrição da imagem aqui")
Invoke-WebRequest -Uri "https://image.pollinations.ai/prompt/$prompt`?width=1024&height=1024&nologo=true" -OutFile "ARQUIVO_SAIDA" -UseBasicParsing
```
